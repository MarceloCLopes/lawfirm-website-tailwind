    ...
    <section id='skills' className='section bg-[#F8F3ECA1] pb-32'>
      <div className='container mx-auto text-center'>
        ...
        <p className='max-w-[540px] mx-auto px-6 lg:px-0 mb-[60px]'>
          ...
          officiis veniam accusantium dolores, neque qui debitis? Fugiat aliquam
          natus ratione, commodi, delectus cum, odio facere voluptatibus eius
          sequi voluptatem fugit.
        </p>
          ...
          {skills.map((item, index) => {
            ...
            return (
              <div className='flex flex-col items-center justify-center mb-16 last:mb-0 lg:mb-0'>
                <img src={icon} className='mb-6' alt='' />
